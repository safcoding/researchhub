    ...
    <div>
      ...
      <footer className="bg-gray-900 text-white py-10 mt-16">
        <div className="container mx-auto px-4">
          ...
          </div>          <div className="border-t border-gray-800 mt-8 pt-6 text-center text-gray-400">
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200">
              <div className="flex justify-between items-start">
                <h2 className="text-2xl font-bold text-gray-900">{infoModalEvent.title}</h2>                <button
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">{infoModalEvent.description}</p>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center text-gray-600">
                      ...
                      <div>
                        ...
                        <p>{formatDate(infoModalEvent.date)}</p>
                      </div>
                    </div>
                    ...
                    {infoModalEvent.registration_required && infoModalEvent.registration_deadline && (
                      <div className="flex items-center text-orange-600">
                        ...
                        <div>
                          ...
                          <p>{formatDate(infoModalEvent.registration_deadline)}</p>
                        </div>
                      </div>
                    )}
                  </div>
              ...
              <div className="border-t border-gray-200 pt-6">
                <div className="flex gap-4">
                  <a 
                    href={`mailto:${infoModalEvent.contact_email}?subject=Inquiry about ${infoModalEvent.title}`}
                    className="flex-1 bg-blue-600 text-white text-center py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors font-medium"
                  >
                    {infoModalEvent.registration_required ? 'Register / Contact Organizer' : 'Contact Organizer'}
                  </a>
                  <button
                    onClick={() => setShowInfoModal(false)}
